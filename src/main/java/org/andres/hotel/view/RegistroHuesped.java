...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(Long idReserva) {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(RegistroHuesped.class.getResource("/org/andres/hotel/imagenes/lOGO-50PX.png")));
		...
		txtFechaN.getCalendarButton().setIcon(
				new ImageIcon(RegistroHuesped.class.getResource("/org/andres/hotel/imagenes/icon-reservas.png")));
		...
		imagenFondo
				.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/org/andres/hotel/imagenes/registro.png")));

		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/org/andres/hotel/imagenes/Ha-100px.png")));
	...
	private void guardarHuesped() {
		...
		Huesped nuevoHuesped = new Huesped(txtNombre.getText(), txtApellido.getText(), fechaN.toString(),
				(String) txtNacionalidad.getSelectedItem(), txtTelefono.getText(), Long.valueOf(txtNreserva.getText()));
