...
import org.andres.hotel.controller.HuespedController;
import org.andres.hotel.controller.ReservaController;
...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(Busqueda.class.getResource("/org/andres/hotel/imagenes/lupa2.png")));
		...
		panel.addTab("Reservas", new ImageIcon(Busqueda.class.getResource("/org/andres/hotel/imagenes/reservado.png")),
				scroll_table, null);
		...
		panel.addTab("Huéspedes", new ImageIcon(Busqueda.class.getResource("/org/andres/hotel/imagenes/pessoas.png")),
				scroll_tableHuespedes, null);
		scroll_tableHuespedes.setVisible(true);

		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(Busqueda.class.getResource("/org/andres/hotel/imagenes/Ha-100px.png")));
	...
	private void modificarReserva() {
		...
		Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
				.ifPresentOrElse(fila -> {
					...
					var filasModificadas = this.reservaController.modificar(fecha_entrada, fecha_salida, valor,
							forma_pago, id);

					JOptionPane.showMessageDialog(this,
							String.format("%d RESERVA - modificado con éxito!", filasModificadas));
	...
	private void modificarHuesped() {
		...
		Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
				.ifPresentOrElse(fila -> {
					...
					var filasModificadas = this.huespedController.modificar(nombre, apellido, fecha_nacimiento,
							nacionalidad, telefono, id);

					JOptionPane.showMessageDialog(this,
							String.format("%d HUÉSPED - modificado con éxito!", filasModificadas));
	...
	private void eliminarReserva() {
		...
		Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
				.ifPresentOrElse(fila -> {
					...
					JOptionPane.showMessageDialog(this,
							cantidadEliminada + " RESERVA - eliminado con éxito! HUÉSPED " + cantidadEliminadaHuesped);
				}, () -> JOptionPane.showMessageDialog(this, "RESERVAS - Por favor, elije un item"));
	}
	...
	private void eliminarHuesped() {
		...
		Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
				.ifPresentOrElse(fila -> {
					...
					JOptionPane.showMessageDialog(this,
							cantidadEliminada + " HUÉSPED - eliminado con éxito! RESERVA " + cantidadEliminadaReserva);
				}, () -> JOptionPane.showMessageDialog(this, "HUÉSPEDES - Por favor, elije un item"));
	}
