...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(ReservasView.class.getResource("/org/andres/hotel/imagenes/aH-40px.png")));
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/org/andres/hotel/imagenes/Ha-100px.png")));
		...
		imagenFondo.setIcon(
				new ImageIcon(ReservasView.class.getResource("/org/andres/hotel/imagenes/reservas-img-3.png")));
		...
		txtFechaEntrada.getCalendarButton()
				.setIcon(new ImageIcon(ReservasView.class.getResource("/org/andres/hotel/imagenes/icon-reservas.png")));
